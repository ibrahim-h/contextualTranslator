...
addon_info = {
	...
	"addon_name": "contextualTranslator",
	# Add-on summary, usually the user visible name of the addon.
	# Translators: Summary for this add-on
	# to be shown on installation and add-on information found in Add-ons Manager.
	"addon_summary": _("Contextual Translator"),
	# Add-on description
...
The default gesture for the addon is: Alt+ Shift+ C."""),
	...
	"addon_url": "https://github.com/ibrahim-h/contextualTranslator.git",
	# Documentation file name
	"addon_docFileName": "readme.html",
	# Minimum NVDA version supported (e.g. "2018.3.0", minor version is optional)
	"addon_minimumNVDAVersion": 2019.3.1.0,
...
pythonSources = ["addon/globalPlugins/contextualTranslator/*.py"]
